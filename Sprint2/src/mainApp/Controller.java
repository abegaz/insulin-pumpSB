...
public void generateRandom(ActionEvent event) {
    ...
    LineChart.getData().addAll(series);
        ...
        timer.scheduleAtFixedRate(new TimerTask(){
                    ...
                    public void run(){
                            ...
                            buttonAction1.setOnAction(new EventHandler<ActionEvent>() {
                                @Override public void handle(ActionEvent e) {
                                	...
                                	if(combobox1.getValue() == "Pizza"){
                                		myNum.setText(Integer.toString(bs1.intakeSugar()));
                                		closeNav.setToY(-(navList.getHeight()));
                                		closeNav.play();
                                	}
                                	else if(combobox1.getValue() == "Soda"){
                                		myNum.setText(Integer.toString(bs1.intakeSugar()));
                                		closeNav.setToY(-(navList.getHeight()));
                                		closeNav.play();
                                	}
                                	else if(combobox1.getValue() == "Rice"){
                                		myNum.setText(Integer.toString(bs1.intakeSugar()));
                                		closeNav.setToY(-(navList.getHeight()));
                                		closeNav.play();
                                	}
                                	else if(combobox1.getValue() == "Candy Bar"){
            ...
            }},1000,10000); //,first parameter is the delay before the FIRST measurement is taken (milliseconds)
