			...
			public void run(){
				Platform.runLater(new Runnable(){ //What allows the UI to be modified
					public void run(){
				        ...
				        TranslateTransition openNav=new TranslateTransition(new Duration(650), navList);
				        openNav.setToY(0);
				        TranslateTransition closeNav=new TranslateTransition(new Duration(650), navList);
